...
export const syncUserProfile = async (authId: string, meta: any): Promise<User | null> => {
    try {
        ...
        if (!profileDoc) {
            ...
            try {
                ...
                const profileData = {
                    ...
                    // age removed to fix schema mismatch
                    points: 0,
                    xp: 0,
                    level: 1,
        ...
        // if (meta.age) updateData.age = parseInt(meta.age.toString()); // Removed to fix schema error
        ...
        const user: User = {
            ...
            age: profileDoc.age || 18, // Default if missing

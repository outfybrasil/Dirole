...
function App() {
  ...
  return (
    <div className="fixed inset-0 h-[100dvh] w-full flex flex-col bg-[#0f0518] text-white font-sans overflow-hidden">
      ...
      <header className="bg-[#0f0518]/80 backdrop-blur-xl z-[60] px-6 py-4 pt-[max(1rem,env(safe-area-inset-top))] border-b border-white/5 flex justify-center sticky top-0 shrink-0">
        <div className="w-full max-w-7xl flex justify-between items-center transition-all">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-dirole-primary to-dirole-secondary p-[2px] shadow-lg overflow-hidden group-hover:rotate-12 transition-transform">
      ...
      {/* BOTTOM NAVIGATION */}
      <nav className="fixed bottom-0 left-0 right-0 bg-[#0f0518]/80 backdrop-blur-xl border-t border-white/5 z-50 px-6 pb-[max(1rem,env(safe-area-inset-bottom))] pt-3 shadow-[0_-10px_40px_rgba(0,0,0,0.5)]">

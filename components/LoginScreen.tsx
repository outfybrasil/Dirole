...
export const LoginScreen: React.FC<LoginScreenProps> = ({ onLoginSuccess }) => {
    ...
    return (
        <div className="fixed inset-0 z-[9999] bg-[#0f0518] overflow-y-auto">
            ...
            {/* Wrapper de Conteúdo: min-h-full garante que o flex center funcione em monitores grandes */}
            <div className="min-h-full w-full flex flex-col items-center justify-center p-4 sm:p-6 relative z-10">

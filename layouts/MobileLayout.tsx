...
export function MobileLayout({ preloadedUser }: MobileLayoutProps) {
    // --- AUTH & SPLASH STATE ---
    const [showSplash, setShowSplash] = useState(!preloadedUser);
    const [isAuthChecking, setIsAuthChecking] = useState(!preloadedUser);
